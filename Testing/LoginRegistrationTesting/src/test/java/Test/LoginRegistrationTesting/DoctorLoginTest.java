...
public class DoctorLoginTest {
	...
	public void login() throws IOException {
		...
		webdriver.findElement(By.xpath("/html/body/app-root/div/app-login/div/div/div[2]/div[1]/form/div[2]/input")).sendKeys("raj123");
		WebElement radio1 = webdriver.findElement(By.xpath("/html/body/app-root/div/app-login/div/div/div[2]/div[1]/form/input[1]"));
		radio1.click();
		
		takeScreenshoot(webdriver,"Doctor Login");
